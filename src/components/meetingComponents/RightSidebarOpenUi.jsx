...
import { BsChatSquareDotsFill, BsChatSquareFill, BsThreeDotsVertical } from 'react-icons/bs'
...
const RightSidebarOpenUi = ({observers, setObservers, activeTab, setActiveTab, currentObserver, setCurrentObserver, selectedChat, setSelectedChat, isWaiting, setIsWaiting, handleTabClick, chatParticipants}) => {
  ...
  const files = [
    { name: 'PRO FILES_01: Introduction...', size: '5.2MB' },
  ];
  const handleSearch = () => {
  ...
  return (
    <>
            ...
            <div className='mb-4'>
              ...
              <h1 className='uppercase font-bold flex-1 text-custom-dark-blue-2'>document hub</h1>
              <Button
              ...
              {/* file div */}
              <div className='bg-custom-gray-8 rounded-xl mx-4 p-2 overflow-y-scroll'>
                {/* title */}
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xs  text-custom-gray-3">{files[0].name}</span>
        </div>
        <div className="flex items-center space-x-4">
          <span className="text-xs text-custom-gray-3">{files[0].size}</span>
