  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
      <div className="bg-white p-8 rounded-2xl w-[420px]">
        ...
        <p className='text-custom-gray-6 text-[11px] mb-10 '>Are you sure you want to remove "{userToRemove.name}"? Once removed, the participant will not able to join the meeting..</p>
