...
const page = () => {
  ...
  const getWaitingList = async (meetingId) => {
    try {
      const response = await axios.get(
        `http://89.116.159.133:8008/api/live-meeting/waiting-list/${meetingId}`
      );
  ...
  const getParticipantList = async (meetingId) => {
    try {
      const response = await axios.get(
        `http://89.116.159.133:8008/api/live-meeting/participant-list/${meetingId}`
      );
  ...
  const getObserverList = async (meetingId) => {
    try {
      const response = await axios.get(
        `http://89.116.159.133:8008/api/live-meeting/observer-list/${meetingId}`
      );
  ...
  const acceptParticipant = async (participant) => {
    try {
      const response = await axios.put(
        `http://89.116.159.133:8008/api/live-meeting/accept-from-waiting-list`,
        {
  ...
  const getMeetingStatus = async (meetingId) => {
    try {
      const response = await axios.get(
        `http://89.116.159.133:8008/api/live-meeting/get-meeting-status/${meetingId}`
      );
  ...
  const getWebRtcMeetingId = async (meetingId) => {
    try {
      const response = await axios.get(
        `http://89.116.159.133:8008/api/live-meeting/get-webrtc-meeting-id/${meetingId}`
      );
  ...
  const getIframeLinkMeetingId = async (meetingId) => {
    try {
      const response = await axios.get(
        `http://89.116.159.133:8008/api/live-meeting/get-iframe-link/${meetingId}`
      );
      // https://serverzoom-mpbv.onrender.com/room/
      // https://testing--inspiring-cendol-60afd6.netlify.app
  ...
  const sendMessageParticipant = async (message) => {
    ...
    const response = await axios.post(
      `http://89.116.159.133:8008/api/live-meeting/send-message-to-participant`,
      {
        message: message,
        meetingId: params.id,
      }
  ...
  const sendMessageObserver = async (message) => {
    try {
    const response = await axios.post(
      `http://89.116.159.133:8008/api/live-meeting/send-message-to-observer`,
      {
        message: message,
        meetingId: params.id,
      }
  ...
  const getParticipantChat = async(meetingId) => {
    try {
      const response = await axios.get(
        `http://89.116.159.133:8008/api/live-meeting/get-participant-chat/${meetingId}`
      );
  ...
  const getObserverChat = async(meetingId) => {
    try {
      const response = await axios.get(
        `http://89.116.159.133:8008/api/live-meeting/get-observer-chat/${meetingId}`
      );
  ...
  const removeParticipant = async () => {
    try {
      response = await axios.put(
        `http://89.116.159.133:8008/api/live-meeting/remove-participant-from-meeting`,
        {
          name: fullName,
          role: userRole,
          meetingId: params.id,
